...
public class AddPersonInDatabase
{

    private static final String[] firstnames =
    { "Horst", "Günter", "Edmund", "Max", "Franz Joseph", "Alfons", "Hans", "Hanns", "Wilhelm", "Fritz" };

    private static final String[] lastnames =
    { "Seehofer", "Beckstein", "Stoiber", "Streibl", "Strauß", "Goppel", "Ehard", "Seidel", "Hoegner", "Schäffer" };
